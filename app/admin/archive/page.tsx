...
interface ArchivePostListPageProps {
...
export default async function ArchivePostListPage(props: ArchivePostListPageProps) {
  ...
  // Build filter query
  const where: any = { postType: "ARCHIVE" };
  if (search) {
    where.OR = [
