    ...
    <div className="relative w-full mx-auto">
      ...
      >
        <div className="mx-auto w-full px-4 sm:px-6 lg:px-8 space-y-6">
          <div className="w-full mx-auto flex flex-col bg-ocragray-200/50 dark:bg-ocragray-900/50 p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-4 lg:gap-8 items-stretch mb-8">
              {/* Left Column: Dossier panel — description, filing info & tags (4/12 cols wide, exactly 2 rows high) */}
              <section className="lg:col-span-4 lg:row-span-2 relative overflow-hidden border border-zinc-200 dark:border-zinc-800 p-6 sm:p-8 h-full flex flex-col justify-between space-y-6">
              ...
              {fonts.length > 0 ? (
                ...
                <div className="lg:col-span-8 flex-1 flex items-center justify-center border border-dashed border-zinc-200 dark:border-zinc-800 p-12 text-center">
                  <p className="font-haas text-sm text-zinc-400 dark:text-zinc-600">No fonts attached to this case file.</p>
                </div>
              )}
            </div>
