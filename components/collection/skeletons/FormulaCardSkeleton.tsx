    ...
    <div className="border border-zinc-200 dark:border-zinc-800 bg-white/50 dark:bg-zinc-950 p-4 rounded-lg flex flex-col sm:flex-row sm:items-stretch justify-between gap-4 animate-pulse">
      <div className="space-y-1 min-w-0 flex-1">
        ...
        <div className="space-y-1.5">
          ...
          <div className="h-4 w-2/3 max-w-md rounded bg-zinc-200 dark:bg-zinc-800" />
        </div>
        <div className="h-3.5 w-1/2 rounded bg-zinc-200 dark:bg-zinc-800 mt-2" />
      </div>

      <div className="shrink-0 flex sm:flex-col items-center sm:items-end justify-between gap-2 sm:gap-0 border-t sm:border-t-0 border-zinc-200 dark:border-zinc-800 pt-2 sm:pt-0.5 sm:pb-1">
        <div className="h-4 w-24 rounded-sm bg-zinc-200 dark:bg-zinc-800" />
